...
namespace IID.Api.Endpoints.CreateVehicleEndpoint;

/// <summary>
/// POST /api/v1/vehicles — creates a new vehicle.
/// Mirrors Sportcast's <c>RequestBetPriceUIEndpoint</c>:
///   • endpoint + request DTO live together in this folder,
///   • HTTP-shape validation lives in <c>Validators/CreateVehicleRequestValidator</c>,
///   • business invariants live in <c>Application/Vehicles/Commands/CreateVehicleCommandValidator</c>.
/// </summary>
